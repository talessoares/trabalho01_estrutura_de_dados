...
public class ControllerEditVehicle {
    ...
    void saveEdit(ActionEvent event) {
        ...
        try {
            ...
            vehicle.setYear(anoInt);
            vehicle.setCategory(category);
            vehicle.setSeats(assentosInt);
            vehicle.setHorsePower(potenciaInt);

            alertInterface("Sucesso", "Veículo editado com sucesso", AlertType.INFORMATION);
    ...
    @FXML
    void createConsult(ActionEvent event) {
        ...
        try {
            ...
            textFieldCategoria.setText(String.valueOf(vehicle.getCategory().getId()));
            textFieldMarca.setText(vehicle.getBrand());
            textFieldModelo.setText(vehicle.getModel());
            textFieldPlaca.setText(vehicle.getPlate());
            textFieldPotencia.setText(String.valueOf(vehicle.getHorsePower()));
